...
public class FlatAltitudeAssigner extends AltitudeAssigner{
    public FlatAltitudeAssigner(double mesh_width_input, double mesh_height_input){
    ...
    protected double calculatePolygonAltitude(double polygonDistanceFromPeak) {
        ...
        The steepness function for this plateau is low close to the peak, and
        slowly descending terrain around the peak */
        return -40*(polygonDistanceFromPeak / maxElevatedDistanceFromPeak)+30;
    }
}
